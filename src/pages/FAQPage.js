  ...
  render() {
    return (
      <main className="ui text container">
        ...
        <p>
          Octopus accepts 8 types of publication—all must be linked to another
          publication somewhere in Octopus. The top of any ‘chain’ is a
          publication that is defining a scientific Problem. Below that you can
          publish a Hypothesis, below that a Method/Protocol, below that
          Data/Results, below that Analysis, below that Discussion and below
          that Applications or translations in the real world. Reviews can be
          published attached to any of those 7 other types of publication.
        </p>
